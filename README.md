...
Razor Pages, Asp.NET Core ile server tabanlı UI web uygulaması geliştirmenin iki yolundan biridir. Burada bir uygulama geliştirilerek proje dosyaları incelenecektir.
## Proje Dosyaları
### Pages Klasörü
