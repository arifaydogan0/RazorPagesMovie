Bu Sayfada Referans Alınan Projenin;  
...
5. Movies/Index sayfasında listeden türe veya ada göre filtreleme yapan bir blok ekledik.(Yorum satırlarında açıklamalar mevcut)
6. Movie modeline Rating isimli bir property ekledik ve ardından EF migrations kullanarak(verileri saklayarak) veritabanını güncelledik.
